...
#         post :create, {:folder => { "user_id" => "invalid value" }}, valid_session
#         assigns(:folder).should be_a_new(Folder)
#       end
...
#         Folder.any_instance.should_receive(:update).with({ "user_id" => "1" })
#         put :update, {:id => folder.to_param, :folder => { "user_id" => "1" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Folder.any_instance.stub(:save).and_return(false)
#         put :update, {:id => folder.to_param, :folder => { "user_id" => "invalid value" }}, valid_session
#         assigns(:folder).should eq(folder)
#       end
